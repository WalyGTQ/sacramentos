...
//    Para mostrar alertas en caso de necesitar Confirmacion
    ...
    public void _imprimirM() throws IOException, DocumentException {
        if (showConfirmationDialog("Confirmar Impresion", "Imprimir registro", "¿Estás seguro? Se Imprimira el registro de: " + feligresDetalle.getNombreMM()+" Y "+feligresDetalle.getNombreFM())) {
            ...
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:/Users/psher/Downloads/Constancia_Matrimonio.pdf"));
            document.open();
            ...
            Image logoB = Image.getInstance("C:/Users/psher/OneDrive/Documentos/Sacramentos/img/casado.png"); //  ruta de  imagen
...
// Añadir el Paragraph al documento
            ...
            try {
                File myFile = new File("C:/Users/psher/Downloads/Constancia_Matrimonio.pdf");
